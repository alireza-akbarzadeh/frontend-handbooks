...
description: 'Best practices for creating accessible HTML content for all users'
---
...
<Steps>
  <Step title="Perceivable">
    ...
    content and creating content that can be presented in different ways.
  </Step>
  <Step title="Operable">
...
<Steps>
  ...
  <Step title="Dynamic Content">
    - [ ] ARIA live regions for dynamic content - [ ] Status messages are
...
<Tip>
  ...
  to ensure they remain accessible as you add new features and content.
</Tip>
